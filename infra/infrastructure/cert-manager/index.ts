...
// --- ClusterIssuer: HTTP-01 (custom domains) ---
...
// --- ClusterIssuer: DNS-01 (wildcard via Hostinger webhook) ---
export const letsencryptDns = new k8s.apiextensions.CustomResource("letsencrypt-dns", {
  apiVersion: "cert-manager.io/v1",
  kind: "ClusterIssuer",
