...
const app = createAppResources({
  ...
  tlsSecretName: config.getBoolean("useWildcardTls") ? "wildcard-tls" : undefined,
  ghcrToken,
  ...
  pointMock: config.getBoolean("pointMock") ?? false,
  runSeed: config.getBoolean("runSeed") ?? false,
