      ...
      template: {
        ...
        spec: {
          containers: [{
            ...
            livenessProbe: { httpGet: { path: "/api/health", port: 3000 }, initialDelaySeconds: 15, periodSeconds: 30 },
            readinessProbe: { httpGet: { path: "/api/health", port: 3000 }, initialDelaySeconds: 10, periodSeconds: 10 },
            resources: args.containers.web.resources,
          }],
          imagePullSecrets: [{ name: "ghcr-secret" }],
        },
      },
